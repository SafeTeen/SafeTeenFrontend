...
const Game = () => {
    ...
    const boxData = [
        {title: "화재 대응", body: "화재가 발생했을 때의 상황에 관한 퀴즈", url: fire, to: "/quiz?title=화재%20대응"},
        {title: "전동 킥보드", body: "전동 킥보드 탑승시 유의 사항에 관한 퀴즈", url: board, to: "/quiz?title=전동%20킥보드"},
        {title: "태풍 피해 예방", body: "태풍 시 행동 요령에 관한 퀴즈", url: wind, to: "/quiz?title=태풍%20피해%20예방"},
        {title: "오토바이", body: "오토바이 탑승시 유의 사항에 관한 퀴즈", url: motorcycle, to: "/quiz?title=오토바이"},
    ]
